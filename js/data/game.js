const game = {
    ...
    achievements: [
        ...
        new Achievement("Stacking up", "Do a restack and restart your progress", PrestigeLayer.getNameForLayer(9), () => game.restackLayer.timesReset > 0),
        ...
        new Achievement("No turning back", "Go meta and be reborn", PrestigeLayer.getNameForLayer(23), () => game.metaLayer.active),
        new Achievement("This is new", "Reach layer 65,536 and find the first tier of infinity", PrestigeLayer.getNameForLayer(mod.Infinities[0] - 1), () => game.metaLayer.layer.gte(mod.Infinities[0])),
        new Achievement("Teralayers", "Reach layer 1 trillion and find the second tier of infinity", PrestigeLayer.getNameForLayer(mod.Infinities[1] - 1), () => game.metaLayer.layer.gte(mod.Infinities[1])),
        new Achievement("Chrome", "Reach layer googol and find the third tier of infinity", PrestigeLayer.getNameForLayer(mod.Infinities[2] - 1), () => game.metaLayer.layer.gte(mod.Infinities[2])),
        new Achievement("A bit more familiar", "Reach layer 2^1024 and find the fourth tier of infinity", PrestigeLayer.getNameForLayer(mod.Infinities[3] - 1), () => game.metaLayer.layer.gte(mod.Infinities[3])),
        new Achievement("The end. Or is it...", "Reach layer ee535 and find the tenth tier of infinity", mod.Infinities[9] - 1, () => game.metaLayer.layer.gte(mod.Infinities[9])),
    ],
    secretAchievements: [
        ...
        new Achievement("Meta sucks!", "Get " + PrestigeLayer.getNameForLayer(23) +  " without meta", "&Omega;&Omega;&Omega;&Omega;&Omega;&Omega;&Omega;&Omega;&Omega;&Omega;", () => game.highestLayer >= 47 && !game.metaLayer.active),
        new Achievement("Volatility sucks!", "Get " + PrestigeLayer.getNameForLayer(4) + " without layer volatility upgrade", "&epsilon;&epsilon;&epsilon;&epsilon;&epsilon;&epsilon;&epsilon;&epsilon;&epsilon;&epsilon;", () => game.highestLayer >= 5 && game.volatility.layerVolatility.level.eq(0)),
    ],
