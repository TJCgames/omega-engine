const game = {
    ...
    achievements: [
        ...
        new Achievement("Upgradier", "Prestige to get a β", "β", () => game.highestLayer >= 1),
        new Achievement("Empowered", "Get β power", 'β<sub>1</sub>', () => (game.layers[1] && game.layers[1].powerGenerators[0].bought.gt(0))),
        new Achievement("Upgradiest", "Prestige to get a γ", "γ", () => game.highestLayer >= 2),
        ...
        new Achievement("Me, myself and I", "Reach layer nif", "Μ", () => game.highestLayer >= 35),
        ...
        new Achievement("I'm baaaack!!", "Reach layer unexian", "Β<sup>Ω</sup>", () => game.metaLayer.layer.gte(mod.Infinities[0])),
    ...
    infinityLayer: new InfinityLayer(),
    currentLayer: null,
