const game = {
    ...
    achievements: [
        ...
        new Achievement("This is new", "Reach layer 65,536 and find the first tier of infinity", GIANTS[0], () => game.metaLayer.layer.gte(mod.Infinities[0])),
        new Achievement("Teralayers", "Reach layer 1 trillion and find the second tier of infinity", GIANTS[1], () => game.metaLayer.layer.gte(mod.Infinities[1])),
        new Achievement("Chrome", "Reach layer googol and find the third tier of infinity", GIANTS[2], () => game.metaLayer.layer.gte(mod.Infinities[2])),
        new Achievement("A bit more familiar", "Reach layer 2^1024 and find the fourth tier of infinity", GIANTS[3], () => game.metaLayer.layer.gte(mod.Infinities[3])),
        new Achievement("The end. Or is it...", "Reach layer ee535 and find the tenth tier of infinity", GIANTS[9], () => game.metaLayer.layer.gte(mod.Infinities[9])),
    ],
    secretAchievements: [
