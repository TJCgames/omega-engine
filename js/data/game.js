const game = {
    ...
    achievements: [
        ...
        new Achievement("Empowered", "Get β power", "β<sub>1</sub>", () => (game.layers[1] && game.layers[1].generators[0].bought.gt(0))),
        ...
        new Achievement("Aleph-0", "Start gaining aleph", "ℵ", () => game.alephLayer.isUnlocked()),
    ...
    secretAchievements: [
        ...
        new Achievement("Aleph-π", "Have πe314 aleph", "&aleph;<sub>π</sub>", () => game.alephLayer.aleph.gte("3.141e314")),
